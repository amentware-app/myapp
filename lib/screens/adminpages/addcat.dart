...
import 'package:myapp/firebase/auth/food_methods.dart';
import 'package:myapp/screens/adminpages/menu.dart';
import 'package:myapp/utils/colors.dart';
import 'package:myapp/utils/imagepicker.dart';
...
class _AddCatState extends State<AddCat> {
  ...
  void addcatfunction() async {
    ...
    String res = await Foodmethods()
        .addcat(catname: _catnameController.text, catpic: _image);
    if (res == "success") {
      setState(() {
        _isLoading = false;
      });
      ...
      Get.back();
      showsnack("Added!!", "Category Added successfully!!!", Icons.food_bank);
    } else {
      setState(() {
        _isLoading = false;
      });
